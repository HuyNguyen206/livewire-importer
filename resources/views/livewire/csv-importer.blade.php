                        ...
                        <div class="py-6 px-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="ml-3 flex h-7 items-center">
                                    <button @click.prevent="open = false" type="button" class="rounded-md text-indigo-200 hover:text-indigo-300 focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <div class="p-4 sm:p-6">
                                    <div>
                                        ...
                                        <div class="max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-md"
                                             ...
                                             :class="isDrop ? 'opacity-70' : 'opacity-100'">
                                    ...
                                    @error('csv') <span class="mt-2 text-red-500 font-medium text-sm">{{ $message }}</span> @enderror
                                    <!-- End file drop -->
